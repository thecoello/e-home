  ...
  return (
    <div className="w-full cursor-pointer">
      <div ref={product} onMouseMove={mouseMove} onMouseLeave={mouseLeave} className="overflow-hidden relative m-1">
        ...
        <div ref={btnOptions} className="absolute z-10 flex w-full justify-between -top-3 left-0 opacity-0">
      ...
      <div className="mt-5 mb-5 pl-5 pr-5 text-base uppercase flex justify-between">
        <div className="w-[80%]">
